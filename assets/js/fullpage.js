  ...
  function addVerticalNavigation() {
    ...
    for (var i = 0; i < getState().sections.length; i++) {
      ...
      if (typeof tooltip !== 'undefined' && tooltip !== '') {
        li += '<li><a href="#' + encodeURI(link) + '"><span class="fp-sr-only">' + getBulletLinkName(section.index(), 'Section') + '</span><span></span><div class="' + SECTION_NAV_TOOLTIP + ' fp-' + getOptions().navigationPosition + '">' + tooltip + '</div></a>'; // Only add tooltip if needed (defined by user)
      }

...
(function ($, document, window, undefined) {
    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function addVerticalNavigation(){
            ...
            for(var cont = 0; cont < $('.pp-section').length; cont++){
                ...
                nav.find('ul').append('<li data-tooltip="' + tooltip + '"><a href="#' + link + '"><span></span><div class="pp-tooltip">' + tooltip + '</div></a></li>');
            }
        ...
        */
        ...
        // // Function to show tooltip for the active navigation menu item
        // function showTooltipForActiveNavItem() {
        //     var activeNavItem = $('#pp-nav .active');
        //     console.log('sdgsfdg', activeNavItem);
        //     if (activeNavItem.length > 0) {
        //         var tooltip = activeNavItem.data('tooltip');
        //         $('<div class="pp-tooltip ' + options.navigation.position + '">' + tooltip + '</div>').hide().appendTo(activeNavItem).fadeIn(200);
        //     }
        // }

        // // Call the function to show the tooltip when the page loads
